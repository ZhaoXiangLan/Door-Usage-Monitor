...
The goal of this project is to build a reliable and scalable system that detects door activity and logs it to the cloud. 
...
### 3. **Timestamp**
The timestamp of each event is generated by the backend server and stored with the record.
...
A magnetic sensor used to detect whether the door is open or closed.
...
```
git clone https://github.com/YOUR_USERNAME/Door-Usage-Monitor.git
